...
const Disclaimer = (): JSX.Element => (
    <DisclaimerDiv>
        ...
        <StyledP>
            This app uses data which is protected by copyright, database rights
            and other intellectual property and related rights owned by{' '}
            <ExternalLink href="https://www.premierleague.com/" target="_blank">
                Premier League
            </ExternalLink>{' '}
